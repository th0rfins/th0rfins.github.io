		...
		<div class="col-md-8">
			<div class="card" style="background-color:transparent;">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong><a href="https://t.me/th0rfins">RadiantCHK</a></strong></h4>
                    <a  
					style="width:140px;"
					></a>
					</h4>
...
Swal.fire({ title: "Fuck!", text: "Fuck this life", icon: "warning", confirmButtonText: "Wubbalubadubdub", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
